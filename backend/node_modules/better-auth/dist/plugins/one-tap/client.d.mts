...
import * as _better_fetch_fetch81 from "@better-fetch/fetch";
...
declare const oneTapClient: (options: GoogleOneTapOptions) => {
  ...
  fetchPlugins: {
    ...
    name: string;
    hooks: {
      onResponse(ctx: _better_fetch_fetch81.ResponseContext): Promise<void>;
    };
  }[];
  getActions: ($fetch: _better_fetch_fetch81.BetterFetch, _: _better_auth_core22.ClientStore) => {
    oneTap: (opts?: GoogleOneTapActionOptions | undefined, fetchOptions?: ClientFetchOption | undefined) => Promise<void>;
  };
  getAtoms($fetch: _better_fetch_fetch81.BetterFetch): {};
};
//#endregion
