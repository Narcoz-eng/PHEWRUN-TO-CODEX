...
declare const oAuthProxy: <O extends OAuthProxyOptions>(opts?: O) => {
  ...
  options: NoInfer<O>;
  endpoints: {
    oAuthProxy: better_call123.StrictEndpoint<"/oauth-proxy-callback", {
      method: "GET";
      operationId: string;
      query: z.ZodObject<{
      ...
      use: ((inputContext: better_call123.MiddlewareInputContext<better_call123.MiddlewareOptions>) => Promise<void>)[];
      metadata: {
        openapi: {
          operationId: string;
          description: string;
