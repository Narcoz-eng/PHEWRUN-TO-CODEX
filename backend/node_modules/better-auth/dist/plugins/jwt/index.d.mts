...
import * as better_call59 from "better-call";
...
declare const jwt: <O extends JwtOptions>(options?: O) => {
  ...
  options: NoInfer<O>;
  endpoints: {
    getJwks: better_call59.StrictEndpoint<string, {
      method: "GET";
      metadata: {
        openapi: {
          operationId: string;
    ...
    getToken: better_call59.StrictEndpoint<"/token", {
      method: "GET";
      requireHeaders: true;
      use: ((inputContext: better_call59.MiddlewareInputContext<better_call59.MiddlewareOptions>) => Promise<{
        session: {
    ...
    signJWT: better_call59.StrictEndpoint<string, {
      method: "POST";
      metadata: {
        $Infer: {
          body: {
    ...
    verifyJWT: better_call59.StrictEndpoint<string, {
      method: "POST";
      metadata: {
        $Infer: {
          body: {
  ...
  hooks: {
    after: {
      ...
      handler: (inputContext: better_call59.MiddlewareInputContext<better_call59.MiddlewareOptions>) => Promise<void>;
    }[];
  };
  schema: {
    jwks: {
