...
declare const magicLink: (options: MagicLinkOptions) => {
  ...
  endpoints: {
     ...
     */
    signInMagicLink: better_call45.StrictEndpoint<"/sign-in/magic-link", {
      method: "POST";
      requireHeaders: true;
      body: z.ZodObject<{
        email: z.ZodEmail;
     ...
     */
    magicLinkVerify: better_call45.StrictEndpoint<"/magic-link/verify", {
      method: "GET";
      query: z.ZodObject<{
        token: z.ZodString;
        callbackURL: z.ZodOptional<z.ZodString>;
      ...
      use: ((inputContext: better_call45.MiddlewareInputContext<better_call45.MiddlewareOptions>) => Promise<void>)[];
      requireHeaders: true;
      metadata: {
        openapi: {
          operationId: string;
