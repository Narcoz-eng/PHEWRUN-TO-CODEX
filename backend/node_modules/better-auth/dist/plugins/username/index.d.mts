...
import * as better_call119 from "better-call";
...
declare const username: (options?: UsernameOptions | undefined) => {
  ...
  endpoints: {
    signInUsername: better_call119.StrictEndpoint<"/sign-in/username", {
      method: "POST";
      body: z.ZodObject<{
    ...
    isUsernameAvailable: better_call119.StrictEndpoint<"/is-username-available", {
      method: "POST";
      body: z.ZodObject<{
        username: z.ZodString;
      }, z.core.$strip>;
  ...
  hooks: {
    before: {
      ...
      handler: (inputContext: better_call119.MiddlewareInputContext<better_call119.MiddlewareOptions>) => Promise<void>;
    }[];
  };
