...
declare const haveIBeenPwned: (options?: HaveIBeenPwnedOptions | undefined) => {
  id: "haveIBeenPwned";
  init(ctx: _better_auth_core19.AuthContext): {
    context: {
      password: {
        ...
        checkPassword: (userId: string, ctx: _better_auth_core19.GenericEndpointContext<_better_auth_core19.BetterAuthOptions>) => Promise<boolean>;
      };
    };
  };
