...
import * as better_call318 from "better-call";
...
declare const apiKey: (options?: ApiKeyOptions | undefined) => {
  ...
  hooks: {
    before: {
      ...
      handler: (inputContext: better_call318.MiddlewareInputContext<better_call318.MiddlewareOptions>) => Promise<{
        user: {
          id: string;
          createdAt: Date;
          updatedAt: Date;
        ...
        context: better_call318.MiddlewareContext<better_call318.MiddlewareOptions, {
          returned?: unknown | undefined;
          responseHeaders?: Headers | undefined;
        } & _better_auth_core29.PluginContext & _better_auth_core29.InfoContext & {
          options: _better_auth_core29.BetterAuthOptions;
          ...
          authCookies: _better_auth_core29.BetterAuthCookies;
          ...
          } & Omit<_better_auth_core29.BetterAuthRateLimitOptions, "enabled" | "window" | "max" | "storage">;
          adapter: _better_auth_core_db_adapter0.DBAdapter<_better_auth_core29.BetterAuthOptions>;
          internalAdapter: _better_auth_core29.InternalAdapter<_better_auth_core29.BetterAuthOptions>;
          createAuthCookie: (cookieName: string, overrideAttributes?: Partial<better_call318.CookieOptions> | undefined) => _better_auth_core29.BetterAuthCookie;
          secret: string;
          sessionConfig: {
            updateAge: number;
            expiresIn: number;
          ...
          password: {
            ...
            checkPassword: (userId: string, ctx: _better_auth_core29.GenericEndpointContext<_better_auth_core29.BetterAuthOptions>) => Promise<boolean>;
          };
  ...
  endpoints: {
     ...
     */
    createApiKey: better_call318.StrictEndpoint<"/api-key/create", {
      method: "POST";
      body: zod617.ZodObject<{
        name: zod617.ZodOptional<zod617.ZodString>;
        expiresIn: zod617.ZodDefault<zod617.ZodNullable<zod617.ZodOptional<zod617.ZodNumber>>>;
        userId: zod617.ZodOptional<zod617.ZodCoercedString<unknown>>;
        prefix: zod617.ZodOptional<zod617.ZodString>;
        remaining: zod617.ZodDefault<zod617.ZodNullable<zod617.ZodOptional<zod617.ZodNumber>>>;
        metadata: zod617.ZodOptional<zod617.ZodAny>;
        refillAmount: zod617.ZodOptional<zod617.ZodNumber>;
        refillInterval: zod617.ZodOptional<zod617.ZodNumber>;
        rateLimitTimeWindow: zod617.ZodOptional<zod617.ZodNumber>;
        rateLimitMax: zod617.ZodOptional<zod617.ZodNumber>;
        rateLimitEnabled: zod617.ZodOptional<zod617.ZodBoolean>;
        permissions: zod617.ZodOptional<zod617.ZodRecord<zod617.ZodString, zod617.ZodArray<zod617.ZodString>>>;
      }, zod_v4_core93.$strip>;
      metadata: {
        openapi: {
          description: string;
     ...
     */
    verifyApiKey: better_call318.StrictEndpoint<string, {
      method: "POST";
      body: zod617.ZodObject<{
        key: zod617.ZodString;
        permissions: zod617.ZodOptional<zod617.ZodRecord<zod617.ZodString, zod617.ZodArray<zod617.ZodString>>>;
      }, zod_v4_core93.$strip>;
    }, {
      valid: boolean;
     ...
     */
    getApiKey: better_call318.StrictEndpoint<"/api-key/get", {
      method: "GET";
      query: zod617.ZodObject<{
        id: zod617.ZodString;
      }, zod_v4_core93.$strip>;
      use: ((inputContext: better_call318.MiddlewareInputContext<better_call318.MiddlewareOptions>) => Promise<{
        session: {
     ...
     */
    updateApiKey: better_call318.StrictEndpoint<"/api-key/update", {
      method: "POST";
      body: zod617.ZodObject<{
        keyId: zod617.ZodString;
        userId: zod617.ZodOptional<zod617.ZodCoercedString<unknown>>;
        name: zod617.ZodOptional<zod617.ZodString>;
        enabled: zod617.ZodOptional<zod617.ZodBoolean>;
        remaining: zod617.ZodOptional<zod617.ZodNumber>;
        refillAmount: zod617.ZodOptional<zod617.ZodNumber>;
        refillInterval: zod617.ZodOptional<zod617.ZodNumber>;
        metadata: zod617.ZodOptional<zod617.ZodAny>;
        expiresIn: zod617.ZodNullable<zod617.ZodOptional<zod617.ZodNumber>>;
        rateLimitEnabled: zod617.ZodOptional<zod617.ZodBoolean>;
        rateLimitTimeWindow: zod617.ZodOptional<zod617.ZodNumber>;
        rateLimitMax: zod617.ZodOptional<zod617.ZodNumber>;
        permissions: zod617.ZodNullable<zod617.ZodOptional<zod617.ZodRecord<zod617.ZodString, zod617.ZodArray<zod617.ZodString>>>>;
      }, zod_v4_core93.$strip>;
      metadata: {
        openapi: {
          description: string;
     ...
     */
    deleteApiKey: better_call318.StrictEndpoint<"/api-key/delete", {
      method: "POST";
      body: zod617.ZodObject<{
        keyId: zod617.ZodString;
      }, zod_v4_core93.$strip>;
     ...
     */
    listApiKeys: better_call318.StrictEndpoint<"/api-key/list", {
      method: "GET";
      use: ((inputContext: better_call318.MiddlewareInputContext<better_call318.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
     ...
     */
    deleteAllExpiredApiKeys: better_call318.StrictEndpoint<string, {
      method: "POST";
    }, {
      success: boolean;
      error: unknown;
