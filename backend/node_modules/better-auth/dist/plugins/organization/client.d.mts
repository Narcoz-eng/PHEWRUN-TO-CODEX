...
declare const organizationClient: <CO extends OrganizationClientOptions>(options?: CO | undefined) => {
  ...
  getActions: ($fetch: _better_fetch_fetch84.BetterFetch, _$store: _better_auth_core23.ClientStore, co: _better_auth_core23.BetterAuthClientOptions | undefined) => {
    $Infer: {
  ...
  getAtoms: ($fetch: _better_fetch_fetch84.BetterFetch) => {
