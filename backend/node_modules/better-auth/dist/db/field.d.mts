...
import * as _better_auth_core_db15 from "@better-auth/core/db";
...
declare const createFieldAttribute: <T extends DBFieldType, C extends DBFieldAttributeConfig>(type: T, config?: C | undefined) => {
  ...
  defaultValue?: (_better_auth_core_db15.DBPrimitive | (() => _better_auth_core_db15.DBPrimitive)) | undefined;
  onUpdate?: (() => _better_auth_core_db15.DBPrimitive) | undefined;
  transform?: {
    input?: (value: _better_auth_core_db15.DBPrimitive) => _better_auth_core27.Awaitable<_better_auth_core_db15.DBPrimitive>;
    output?: (value: _better_auth_core_db15.DBPrimitive) => _better_auth_core27.Awaitable<_better_auth_core_db15.DBPrimitive>;
  } | undefined;
  references?: {
    model: string;
    field: string;
