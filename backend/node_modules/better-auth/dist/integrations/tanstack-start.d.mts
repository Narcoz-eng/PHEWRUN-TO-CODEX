...
import * as better_call13 from "better-call";
...
declare const tanstackStartCookies: () => {
  ...
  hooks: {
    after: {
      matcher(ctx: _better_auth_core3.HookEndpointContext): true;
      handler: (inputContext: better_call13.MiddlewareInputContext<better_call13.MiddlewareOptions>) => Promise<void>;
    }[];
  };
};
//#endregion
