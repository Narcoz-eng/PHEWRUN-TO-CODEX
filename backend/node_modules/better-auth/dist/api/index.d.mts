...
declare function getEndpoints<Option extends BetterAuthOptions>(ctx: Awaitable<AuthContext>, options: Option): {
  api: {
    readonly ok: better_call130.StrictEndpoint<"/ok", {
      method: "GET";
      metadata: {
        openapi: {
          description: string;
    ...
    readonly error: better_call130.StrictEndpoint<"/error", {
      method: "GET";
      metadata: {
        openapi: {
          description: string;
    ...
    readonly signInSocial: better_call130.StrictEndpoint<"/sign-in/social", {
      method: "POST";
      operationId: string;
    ...
    readonly callbackOAuth: better_call130.StrictEndpoint<"/callback/:id", {
      method: ("GET" | "POST")[];
      operationId: string;
    ...
    readonly getSession: better_call130.StrictEndpoint<"/get-session", {
      method: "GET";
      operationId: string;
      query: zod80.ZodOptional<zod80.ZodObject<{
    ...
    readonly signOut: better_call130.StrictEndpoint<"/sign-out", {
      method: "POST";
      operationId: string;
      requireHeaders: true;
      metadata: {
    ...
    readonly signUpEmail: better_call130.StrictEndpoint<"/sign-up/email", {
      method: "POST";
      operationId: string;
      use: ((inputContext: better_call130.MiddlewareInputContext<better_call130.MiddlewareOptions>) => Promise<void>)[];
    ...
    readonly signInEmail: better_call130.StrictEndpoint<"/sign-in/email", {
      method: "POST";
      operationId: string;
      use: ((inputContext: better_call130.MiddlewareInputContext<better_call130.MiddlewareOptions>) => Promise<void>)[];
      body: zod80.ZodObject<{
    ...
    readonly resetPassword: better_call130.StrictEndpoint<"/reset-password", {
      method: "POST";
      operationId: string;
      query: zod80.ZodOptional<zod80.ZodObject<{
    ...
    readonly verifyPassword: better_call130.StrictEndpoint<"/verify-password", {
      method: "POST";
      body: zod80.ZodObject<{
        password: zod80.ZodString;
      }, zod_v4_core15.$strip>;
      ...
      use: ((inputContext: better_call130.MiddlewareInputContext<better_call130.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly verifyEmail: better_call130.StrictEndpoint<"/verify-email", {
      method: "GET";
      operationId: string;
    ...
    readonly sendVerificationEmail: better_call130.StrictEndpoint<"/send-verification-email", {
      method: "POST";
      operationId: string;
      body: zod80.ZodObject<{
        email: zod80.ZodEmail;
    ...
    readonly changeEmail: better_call130.StrictEndpoint<"/change-email", {
      method: "POST";
      body: zod80.ZodObject<{
    ...
    readonly changePassword: better_call130.StrictEndpoint<"/change-password", {
      method: "POST";
      operationId: string;
      body: zod80.ZodObject<{
        newPassword: zod80.ZodString;
    ...
    readonly setPassword: better_call130.StrictEndpoint<string, {
      method: "POST";
      body: zod80.ZodObject<{
        newPassword: zod80.ZodString;
      }, zod_v4_core15.$strip>;
    ...
    readonly updateUser: better_call130.StrictEndpoint<"/update-user", {
      method: "POST";
      operationId: string;
    ...
    readonly deleteUser: better_call130.StrictEndpoint<"/delete-user", {
      method: "POST";
      use: ((inputContext: better_call130.MiddlewareInputContext<better_call130.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly requestPasswordReset: better_call130.StrictEndpoint<"/request-password-reset", {
      method: "POST";
      body: zod80.ZodObject<{
        email: zod80.ZodEmail;
    ...
    readonly requestPasswordResetCallback: better_call130.StrictEndpoint<"/reset-password/:token", {
      method: "GET";
      operationId: string;
      query: zod80.ZodObject<{
    ...
    readonly listSessions: better_call130.StrictEndpoint<"/list-sessions", {
      method: "GET";
      operationId: string;
      use: ((inputContext: better_call130.MiddlewareInputContext<better_call130.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly revokeSession: better_call130.StrictEndpoint<"/revoke-session", {
      method: "POST";
      body: zod80.ZodObject<{
        token: zod80.ZodString;
      }, zod_v4_core15.$strip>;
    ...
    readonly revokeSessions: better_call130.StrictEndpoint<"/revoke-sessions", {
      method: "POST";
      use: ((inputContext: better_call130.MiddlewareInputContext<better_call130.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly revokeOtherSessions: better_call130.StrictEndpoint<"/revoke-other-sessions", {
      method: "POST";
      requireHeaders: true;
      use: ((inputContext: better_call130.MiddlewareInputContext<better_call130.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly linkSocialAccount: better_call130.StrictEndpoint<"/link-social", {
      method: "POST";
      requireHeaders: true;
      body: zod80.ZodObject<{
        callbackURL: zod80.ZodOptional<zod80.ZodString>;
    ...
    readonly listUserAccounts: better_call130.StrictEndpoint<"/list-accounts", {
      method: "GET";
      use: ((inputContext: better_call130.MiddlewareInputContext<better_call130.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly deleteUserCallback: better_call130.StrictEndpoint<"/delete-user/callback", {
      method: "GET";
      query: zod80.ZodObject<{
        token: zod80.ZodString;
        callbackURL: zod80.ZodOptional<zod80.ZodString>;
    ...
    readonly unlinkAccount: better_call130.StrictEndpoint<"/unlink-account", {
      method: "POST";
      body: zod80.ZodObject<{
    ...
    readonly refreshToken: better_call130.StrictEndpoint<"/refresh-token", {
      method: "POST";
      body: zod80.ZodObject<{
        providerId: zod80.ZodString;
        accountId: zod80.ZodOptional<zod80.ZodString>;
    ...
    readonly getAccessToken: better_call130.StrictEndpoint<"/get-access-token", {
      method: "POST";
      body: zod80.ZodObject<{
        providerId: zod80.ZodString;
        accountId: zod80.ZodOptional<zod80.ZodString>;
    ...
    readonly accountInfo: better_call130.StrictEndpoint<"/account-info", {
      method: "GET";
      use: ((inputContext: better_call130.MiddlewareInputContext<better_call130.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
