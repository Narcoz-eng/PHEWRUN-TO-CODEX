...
// Connect wallet
// TODO: For production, enforce signature verification for profile wallet connect updates.
// (Wallet sign-in flow already verifies signature at /api/auth/wallet.)
