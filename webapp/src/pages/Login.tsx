...
export default function Login() {
  ...
  useEffect(() => {
    ...
    if (authError) {
      setError("Google sign-in failed. Please check OAuth configuration and try again.");
    }
  }, [location.search]);
  ...
  const handleWalletConnect = () => {
    ...
    setError(null);
    if (inIframe) {
      setError("Wallet connection is blocked in embedded iframes. Open this app in a browser tab and try again.");
      return;
    }
              ...
              >
                ...
                {inIframe && (
                  <div className="p-3 rounded-lg bg-amber-500/10 border border-amber-500/20 text-amber-600 dark:text-amber-400 text-sm mb-4 flex items-start gap-2">
                    ...
                    <span>Google and wallet extension sign-in are blocked when viewing in an embedded iframe. Open this app in a new browser tab.</span>
                  </div>
                )}
                ...
                <div className="space-y-3 relative z-10">
                  ...
                  {!walletAuth.hasAvailableWallets && !inIframe && (
                    <p className="text-xs text-amber-600 dark:text-amber-400 text-center">
                      No compatible wallet extension detected. Install Phantom or Solflare, then refresh.
                    </p>
                  )}
