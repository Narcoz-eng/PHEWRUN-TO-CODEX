              ...
              <div className="mt-4 p-4 bg-secondary/50 rounded-xl border border-border/50">
                ...
                {localSettled ? (
                  <div className="mt-3 space-y-2">
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            >
                              {percentChange6h !== null
                                ? `${percentChange6h >= 0 ? "+" : ""}${percentChange6h.toFixed(2)}%`
                                : "N/A"}
                            </span>
                          </div>
                        </div>
                    ...
                    {/* Current Mcap - Reference with profit/loss coloring */}
                    <div
                      className={cn(
                        "p-2 rounded-lg border",
                        isGainCurrent && "bg-gain/5 border-gain/20",
                        isLossCurrent && "bg-loss/5 border-loss/20",
                        !isGainCurrent && !isLossCurrent && "bg-background/20 border-border/30"
                      )}
                    >
                      <div className="flex items-center justify-between">
                        <p
                          className={cn(
                            ...
                            isGainCurrent && "text-gain/60",
                            isLossCurrent && "text-loss/60",
                            !isGainCurrent && !isLossCurrent && "text-muted-foreground opacity-70"
                          )}
                        >
                          Current
                        </p>
                        <div className="flex items-center gap-1">
                          ...
                          >
                            {percentChangeCurrent !== null
                              ? `${percentChangeCurrent >= 0 ? "+" : ""}${percentChangeCurrent.toFixed(2)}%`
                              : "N/A"}
                          </span>
                        </div>
                      </div>
                  ...
                  <div className="mt-3 grid grid-cols-2 gap-3">
                    <div className="p-2 bg-background/30 rounded-lg border border-primary/20">
                      <div className="flex items-center gap-1.5">
                        <span className="relative flex h-2 w-2">
                          <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary opacity-75"></span>
                          <span className="relative inline-flex rounded-full h-2 w-2 bg-primary"></span>
                        </span>
                        <p className="text-[10px] text-primary uppercase tracking-wider font-semibold">Live Mcap</p>
                      </div>
                      <p className="text-base font-mono font-semibold text-foreground mt-1">
                        {formatMarketCap(currentMcap)}
                      </p>
                    </div>
                    <div className="p-2 bg-background/30 rounded-lg border border-border/50">
